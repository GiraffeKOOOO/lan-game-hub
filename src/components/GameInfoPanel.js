    ...
    return (
      <>
        <Card className="mx-auto w-[800px] my-[40px]">
          ...
          />
          <Card.Body className="text-center p-1">
            <Card.Title className="mb-0 border-y-2 py-[15px]">
              {selectedGame.title}
            </Card.Title>
            ...
            <div className="grid grid-cols-2">
              <div>
                ...
                {isUserPlaying ? (
                  <p className="mb-[4px] border-2 border-green-500 text-green-600 rounded-[10px] p-[5px] w-40 mx-auto">
                    Playing
                  </p>
                ) : (
              ...
              {isUserPlaying ? (
                <Button
                  className="w-40 h-10 my-auto mx-auto"
                  variant="danger"
